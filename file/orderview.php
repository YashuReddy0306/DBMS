		...
		<table align="center" border="1px" style="width: 1000px; line-height: 30px; border: 3px solid black; background-color: white; ">
			...
			while($row=mysqli_fetch_array($query)){
				...
				<tr>
	                ...
	                <td style="font-weight: bold;font-size: 1.3em; font-style: italic; text-align: center;"><a href="trackedit.php?a=<?php echo $row['trackID']; ?> & b=<?php echo $row['email'];?>">Edit</a></td>
